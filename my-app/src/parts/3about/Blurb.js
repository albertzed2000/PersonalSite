...
class Blurb extends React.Component{
  ...
  render(){
    return(
      <div>
        <p>Hi! My name is Albert and I'm a student at the University of Toronto, where I'm currently double majoring in 
Computer Science and Economics. I built this website with my knowledge in react and bootstrap to showcase coding projects that I've done.
 If I had to list my interests and hobbies out, the list would be very long. However, a few of my
...
company, don't hesitate to contact me! I promise that I am a cool person to work with :)</p>
