...
class AboutBlurb extends React.Component{
  ...
  render(){
    return(
      <div>
        <h5>Hi! My name is Albert and I'm a student at the University of Toronto, where I'm currently double majoring in 
...
company, don't hesitate to contact me! I promise that I am a cool person to work with :)</h5>
